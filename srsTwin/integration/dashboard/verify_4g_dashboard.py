...
check("index.html has lw5gEventClick",        "lw5gEventClick" in html_src)
check("index.html has lw5g-detail-panel",     "lw5g-detail-panel" in html_src)
check("index.html has lw5g-cf-split layout",  "lw5g-cf-split" in html_src)
check("index.html has run-gap in SVG builder","GAP_H" in html_src)
check("parse_lw5g raw_line field",            "raw_line" in open(os.path.join(HERE,"parse_lw5g.py"),encoding="utf-8").read())
